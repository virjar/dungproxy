...
public class RequestForm {
    ...
    private Integer requestNumber; // 期望获取资源数目
    ...
    private String distributeStrategy = "soft";// soft mix strict
    ...
    private String matchExpress;// transparent:10,matchISP:100,maxPing:50 -1/maxPing
    private String doaminList;// 打算访问的目标网站的数据
    private Boolean mastMatchDomainUseful;
}
