...
import com.virjar.dungproxy.client.ippool.support.http.stat.*;
import com.virjar.dungproxy.client.ippool.support.profile.ProfileEntryKey;
import com.virjar.dungproxy.client.ippool.support.profile.ProfileEntryReqStat;
import com.virjar.dungproxy.client.ippool.support.profile.Profiler;
import com.virjar.dungproxy.client.util.DruidWebUtils;
import com.virjar.dungproxy.client.util.PatternMatcher;
import com.virjar.dungproxy.client.util.ServletPathMatcher;
...
public class WebStatFilter extends AbstractWebStatImpl implements Filter {
    ...
    private final static Logger LOG                               = LoggerFactory.getLogger(WebStatFilter.class);
