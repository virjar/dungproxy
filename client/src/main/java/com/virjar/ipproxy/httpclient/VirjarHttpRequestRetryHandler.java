 ...
 * under the License. ==================================================================== This software consists of
 * voluntary contributions made by many individuals on behalf of the Apache Software Foundation. For more information on
 ...
 */
@Immutable
public class VirjarHttpRequestRetryHandler implements HttpRequestRetryHandler {
    ...
    public static VirjarHttpRequestRetryHandler INSTANCE = new VirjarHttpRequestRetryHandler();
     ...
     * @since 4.3
     */
    protected VirjarHttpRequestRetryHandler(final int retryCount, final boolean requestSentRetryEnabled,
    ...
    public VirjarHttpRequestRetryHandler(final int retryCount, final boolean requestSentRetryEnabled) {
    ...
    /**
     * @return {@code true} if this handler will retry methods that have successfully sent their request, {@code false}
     *         otherwise
     */
